 ...
 * @param {function} callback
 */
Service.prototype.update = function(auth, opts, version, callback) {
  if (!callback && typeof version === 'function') {
    callback = version;
    version = opts;
    opts = auth;
  ...
  var optsf = {
    path: '/services/' + this.id + '/update?version=' + (version || opts.version),
    method: 'POST',
    statusCodes: {
      200: true,
      404: 'no such service',
